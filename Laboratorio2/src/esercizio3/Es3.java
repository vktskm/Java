 ...
 * Di seguito viene presentato un esempio di I/O risultante dall'esecuzione del programma 
 * Java implementato:
...
public class Es3 {
	...
	public static void main(String[] args) {
		...
		Scanner tastiera = new Scanner(System.in);
	      ...
	      String nuovoMessaggio = messaggio.substring(0,posizione) + stringa +messaggio.substring(posizione);
