...
/*
 * Scrivere un programma Java che legga da tastiera due stringhe di 5 
 * caratteri ciascuna, formate dai caratteri
 * + e -. Ad esempio:
 * Inserisci la prima stringa: +++--
 * Inserisci la seconda stringa: -+--+
 * Se le stringhe inserite non sono entrambe di 5 caratteri, o se i 
 * caratteri sono diversi da + e -, il programma stampa un messaggio 
 * d’errore e termina l’esecuzione.
 * Siano poi a e b due variabili intere, inizializzate rispettivamente 
 * con i valori 0 e 4. La prima stringa indica le operazioni di incremento 
 * e di decremento da fare al valore della variabile a;analogamente, la 
 * seconda stringa indica le operazioni di incremento e decremento da 
 * applicare al valore della variabile b. 
 * Il programma deve applicare il primo incremento/decremento specificato 
 * per entrambe le variabili, poi il secondo incremento/decremento ad 
 * entrambe, e così via, stampando ogni volta a video i valori ottenuti 
 * per le due variabili. Se dopo un incremento/decremento di entrambe le 
 * variabili dovesse capitare che a e b assumono lo stesso valore, stampare 
 * un messaggio a video e terminare l’esecuzione del programma.
 * Segue un esempio di output prodotto dal programma, dopo aver inserito le 
 * due stringhe dell’esempio dato sopra:
