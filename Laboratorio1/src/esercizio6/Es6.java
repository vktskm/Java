 ...
 * • stampi a video le misure delle basi e dell’altezza e l’area 
 * del trapezio, in modo che l’output abbia la forma seguente:
...
public class Es6 {
	...
	public static void main(String[] args) {
		...
		System.out.println("> Area = " + area);//Area = 13.5
	}
